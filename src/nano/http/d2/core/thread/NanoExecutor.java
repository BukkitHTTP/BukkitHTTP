...
public class NanoExecutor {
    ...
    public static final ExecutorService executorService = new ThreadPoolExecutor(2, 20, 60L, TimeUnit.SECONDS, new LinkedBlockingQueue<>(1), new NanoThreadFactory("Worker"), new NanoAbortPolicy());
    public static final ExecutorService errorExecutorService = new ThreadPoolExecutor(1, 3, 30L, TimeUnit.SECONDS, new LinkedBlockingQueue<>(40), new NanoThreadFactory("ErrorHandler"), new NanoAbortPolicy());
}
